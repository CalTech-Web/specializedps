      ...
      {categories.map((cat) => (
        ...
        >
          ...
          <div className="absolute inset-x-0 bottom-0 flex flex-col items-center pb-10 sm:pb-14">
            <h3 className="font-heading text-xl font-bold tracking-wider text-white">
              {cat.name}
            </h3>
            <span className="mt-4 inline-block rounded-md border-2 border-white bg-transparent px-6 py-2.5 text-xs font-bold tracking-[0.15em] text-white opacity-0 transition-all duration-300 group-hover:opacity-100 hover:bg-white hover:text-heading">
              View Procedures
            </span>
          </div>
        </Link>
