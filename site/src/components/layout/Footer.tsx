  ...
  return (
    <footer>
      ...
      <div className="relative min-h-[400px] overflow-hidden sm:min-h-[500px]">
        ...
        {/* Content */}
        <div className="relative z-10 flex min-h-[400px] items-center py-14 sm:min-h-[500px] sm:py-20">
      ...
      <div className="relative overflow-hidden bg-white py-10">
        ...
        <div className="relative mx-auto max-w-[1320px] px-6">
          {/* Desktop: Maps row + Locations row (hidden on mobile) */}
          ...
          {/* Mobile: Map + Details grouped per location (hidden on desktop) */}
      ...
      <div className="bg-heading py-4">
        <div className="mx-auto flex max-w-[1320px] flex-col items-center gap-1 px-6 text-center sm:flex-row sm:justify-between sm:text-left">
