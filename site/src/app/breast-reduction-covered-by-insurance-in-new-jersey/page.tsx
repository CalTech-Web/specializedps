  ...
  return (
    <>
      ...
      <section className="relative flex min-h-[520px] w-full items-center justify-center overflow-hidden bg-heading">
        <Image
          src="https://images.unsplash.com/photo-1768479619439-7d6d495628bf?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
