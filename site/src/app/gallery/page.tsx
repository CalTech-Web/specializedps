    ...
    <>
      ...
      <section className="relative flex h-[400px] w-full items-end justify-center overflow-hidden bg-heading">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-6 pb-16 pt-32 text-center sm:pb-20">
          ...
          <p className="mx-auto mt-8 max-w-3xl text-sm leading-relaxed text-white/85">
      ...
      <GalleryAgeGate>
                      ...
                      {categories.map((cat) => (
                        <li key={cat.slug}>
                          <Link
                            ...
                            className="inline-block text-sm text-body transition-colors hover:text-primary"
                          >
                            {cat.label}
                          </Link>
                        </li>
        ...
        <section className="relative overflow-hidden">
          ...
          />
          <div className="relative mx-auto max-w-[1320px] px-6 py-14 sm:py-20">
        ...
        <section className="overflow-hidden py-14 sm:py-20" style={{ backgroundImage: "url('/images/gallery-page/marble-bg.webp')", backgroundSize: "cover", backgroundPosition: "center" }}>
          <div className="mx-auto max-w-2xl px-6">
            ...
            <p className="mx-auto mt-4 max-w-xl text-center text-sm leading-relaxed text-body">
