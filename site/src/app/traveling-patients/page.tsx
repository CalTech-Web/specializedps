...
export const metadata: Metadata = {
  ...
  description:
    "Specialized Plastic Surgery welcomes traveling patients from across the country. Learn about accommodation assistance, transportation options, and remote follow-up care.",
};
